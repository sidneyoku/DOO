...
import crud.validacao.Validacao;
...
public class CadastroPessoa extends javax.swing.JFrame {
        ...
        if (Utils.isNumber(campoId.getText())) {
           try {
                ...
                if (p != null) {
                    ...
                    System.out.println("IdEstado: " + p.getIdEstado());
                    System.out.println("IdCidade: " + p.getIdCidade());
                    System.out.println("IdEstados...: " + idEstados.get(p.getIdEstado()));
                    
                    ICidade iCidade = new CidadeDao();
                    Cidade c = iCidade.findById(p.getIdCidade());
                    
                    campoNome.setText(p.getNome());
                    comboEstado.setSelectedIndex(p.getIdEstado()-1);
    ...
    private void comboEstadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboEstadoActionPerformed
        preencherComboCidades(idEstados.get(comboEstado.getSelectedIndex()));
//        preencherComboCidades(comboEstado.getSelectedIndex()-1);
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        if (listaObrigatorio.size() > 0) {
            ...
            ICidade iCidade = new CidadeDao();
            Cidade c = iCidade.getCidadeByNomeIdEstado(comboCidade.getSelectedItem().toString(), e.getId());
    ...
    private void preencherComboEstado() {
        try {
            IEstado iEstado = new EstadoDao();
            List<Estado> listEstados = iEstado.getAll();
    ...
    private void preencherComboCidades(int idEstado) {
        idCidades = new ArrayList<>();
        comboCidade.removeAllItems();
        
        try {
            ICidade iCidade = new CidadeDao();
            List<Cidade> listCidades = iCidade.getCidadeByIdEstado(idEstado);
...
//            listCidades.stream().map((cidade) -> {
//                idCidades.add(cidade.getId());
//                return cidade;
//            }).forEachOrdered((cidade) -> {
    ...
    public Runnable newAtualizaPessoasAction() {
        return new Runnable() {
            public void run() {
                try {
                    IPessoa iPessoa = new PessoaDao();
                    List<Pessoa> listPessoas = iPessoa.getAll();
                    String strPessoa = "";
