...
//        SwingUtilities.invokeLater(preencherComboEstadoAction());
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        List<String> listaObrigatorio = Validacao.ValidaCamposCidade(campoNome.getText(), idEstados.get(comboEstado.getSelectedIndex()));
        ...
        if (listaObrigatorio.size() > 0) {
            ...
            Cidade c = new Cidade(campoId.getText().isBlank() ? null : Integer.parseInt(campoId.getText()), campoNome.getText().trim(), idEstados.get(comboEstado.getSelectedIndex()));
            ICidade iCidade = new CidadeDao();
            iCidade.save(c);
    ...
    public Runnable newAtualizaCidadesAction() {
        return new Runnable() {
            public void run() {
                try {
                    ICidade iCidade = new CidadeDao();
                    List<Cidade> listCidades = iCidade.getAll();
                    String strCidade = "";
